...
```
```
python3 resnet152-4modules-tinyimagenet.py -cln 1CNN -trt par -ne0 300 -opt sgd -lrt 0.003 -bas 256 -lbs 0.1 -inn orthogonal -ing 0.1 -tra 1 -tau 1000000 -vta 1 -see 0
```

Experiments in Table 4

```
python3 swin-4modules.py -dat stl10 -bas 1024 -clp 1000000 -mlp 4 -ptc 4 -win 6 -lrt 0.007 -tau 0 -vta 0 -see 0
```
```
python3 swin-4modules.py -dat stl10 -bas 1024 -clp 1000000 -mlp 4 -ptc 4 -win 6 -lrt 0.007 -tau 10 -vta 0 -see 0
```
